            ...
            <div class="box-border">
                <div class="snb_area m-0 p-0 float-left w-[150px]">
                    ...
                    <nav class="snb">
                        <div class="snb_list">
                            <ul class="snb_menu">
                                <li><a href="#" onclick="location.href='/ReseltProject/notice/noticeList'" aria-current="page" class="menu_item menu_on mb-2 text-[#222] font-semibold tracking-[-.15px] leading-[18px]"> 공지사항 </a></li>
