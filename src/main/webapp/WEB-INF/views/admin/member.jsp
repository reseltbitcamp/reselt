      ...
      <div class="content content_area ml-[180px] overflow-hidden">
        <div class="my_admin_header flex h-[60px] w-full items-center bg-[#ECECEC] p-[10px] px-[40px]">
          ...
          <div class="search h-[35px] rounded-[8px] bg-[#fff] pl-[10px] ml-auto flex">
            <i class="fa-solid fa-magnifying-glass mt-[10px] pr-[10px] text-[#CFCFCF] bg"></i>
            ...
            <div class="my_admin_main-content">
              ...
              <div class="my_admin_main-content-list">
                ...
                <div class="my_list not_empty_area_2">
                  <div class="basic border-b-solid border-b-[1px] border-b-[#171414] pt-[10px] pb-[9px] pl-[80px]">
                    <div class="my_item relative">
                      <div class="my_admin_main-content-title-detail">
                        <div class="flex">
                          <div class="flex w-[90%]">
                          	<div>
                            	<span class="mt-[5px] w-[30px] text-[12px] font-semibold text-[#6A6A6A]">26</span>
                            </div>
                            <div class="flex justify-between w-[90%] ml-[23%]">
                            	<span class="mt-[5px] w-[20%] text-center text-[12px] font-semibold text-[#6A6A6A]">안녕</span>
                            	<span class="mt-[5px] w-[20%] text-center text-[12px] font-semibold text-[#6A6A6A] pl-[3%]">2022/07/21</span>
                            	<span class="mt-[5px] w-[20%] text-center text-[12px] font-semibold text-[#6A6A6A] pl-[5%]">hello@naver.com</span>
                          	</div>
                          </div>
