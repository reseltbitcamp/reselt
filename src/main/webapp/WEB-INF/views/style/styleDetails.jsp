		...
		$.ajax({
			...
			dataType: 'json',
	       	success:function(data){
				...
				$('<div id="replyUserViewBox" class="'+data.replyDTO.style_seq+' w-[115px] h-[56px] py-2 float-left"><div id="replyUserViewImage" class="bg-slate-200 rounded-full w-[34px] h-[34px] float-left overflow-hidden"><img src="http://3.39.241.175:6753/upload/resources/img/myPage/'+data.replyDTO.memberDTO.profile_img+'" alt="프로필 사진"></div><div id="replyUserViewName" class="inline w-[50px] font-medium float-left text-xs px-1 pt-1">'+data.replyDTO.memberDTO.nick+'</div><div id="replyViewdate" class="inline float-left text-xs px-1">'+data.replyDTO.created_at+'</div></div><div id="replyViewContent" class="'+data.replyDTO.style_seq+' w-full h-[56px] text-xs pt-3"><div id="replyContentText">'
