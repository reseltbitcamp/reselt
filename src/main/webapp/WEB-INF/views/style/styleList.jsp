	...
	$.ajax({
		...
		success: function(data){
			...
			$.each(data.list, function(index, items){
				$('<div class="shrink-0 basic-1/8 w-[250px] mx-auto"><div id="styleImage" class="rounded-xl overflow-hidden cursor-pointer" onclick="getStyleDetails('+items.seq+')"><img src="http://3.39.241.175:6753/upload/resources/img/style/'
						+items.style_image+'" alt="'
						+items.memberDTO.nick+'님 게시글"></div><div id="cardDetail" class="h-[146px] px-1"><div id="userBox" class="h-[37px] py-2 cursor-pointer" onclick="getStyleDetails('+items.seq+')"><div id="userImage" class="bg-slate-200 rounded-full w-[20px] h-[20px] float-left overflow-hidden"><img src="http://3.39.241.175:6753/upload/resources/img/myPage/'+items.memberDTO.profile_img+'" alt="프로필 사진"></div><div id="userName" class="inline float-left text-xs px-1">'
