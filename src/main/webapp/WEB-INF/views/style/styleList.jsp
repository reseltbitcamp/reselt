		...
		success: function(data){
			$.each(data.list, function(index, items){
				...
				$('<div class="shrink-0 basic-1/8 w-[250px] h-[480px] mx-auto"><div id="styleImage" class="h-[300px] rounded-xl overflow-hidden cursor-pointer" onclick="getStyleDetails('+items.seq+')"><img src="/ReseltProject/styleImage/'
						...
						+items.countcmt+'</span></div><div id="productList" class="w-full h-[41px] pr-2 cursor-pointer" onclick="shopDetailRevising()"><div id="productImage" class="bg-sky-100 rounded-md w-[40px] h-[40px] float-left mr-2"><img src="/ReseltProject/img/style/productImage.png" alt="나이키 신발"></div><p id="productName" class="text-xs">'
...
function shopDetailRevising(){
	location.href = '/ReseltProject/shop/shopDetailRevising';	
}
</script>