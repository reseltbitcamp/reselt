  ...
  <div class="h-[480px]">
    ...
    <div id="cardDetail" class="h-[146px] px-1">
      <div id="userBox" class="h-[37px] py-2">
        ...
        <div id="userName" class="inline float-left text-xs px-1">miing.9</div>
      </div>
      <p id="textBox" class="leading-normal text-xs">요즘 최애탬 😎 Insta:miing.9 슈프림포스 최고. supremenike KREAM...</p>
	...
	<!-- like, 댓글 -->
      <div id="btnBox" class="w-full h-10 pt-2">
        ...
        <span id="likeCount" class="text-sm">137</span>
        ...
        <span id="commentCount" class="text-sm">3</span>
      </div>
      ...
      <div id="productList" class="w-full h-[41px] pr-2">
        <div id="productImage" class="bg-sky-100 rounded-md w-[40px] h-[40px] float-left mr-2">
          ...
          <p id="productName" class="text-xs">Nike x Supreme Air Force 1...</p>
